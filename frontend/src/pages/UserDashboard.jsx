                    ...
                    {bookings.map((booking) => (
                        <div key={booking._id} className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition border border-gray-100 flex flex-col">
                                ...
                                {booking.inviteId ? (
                                    <>
                                        <div className="flex justify-between items-start mb-4">
                                            <h3 className="text-lg font-bold text-gray-900 leading-tight">{booking.inviteId.title}</h3>
                            ...
                            <div className="p-4 bg-gray-50 flex justify-between items-center shrink-0">
                                {booking.inviteId && booking.status !== 'cancelled' ? (
                                    <>
                                        <Link to={`/invites/${booking.inviteId._id}`} className="text-gray-900 font-semibold text-sm hover:underline">View Invite</Link>
                                        <button
